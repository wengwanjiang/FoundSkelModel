...
# modifed based on https://github.com/ECHO960/PKU-MMD/blob/master/evaluate.py
...
source_folder = os.getenv('SOURCE_FOLDER', './default/path/')#'./detect_result/'
ground_folder = os.getenv('GROUND_FOLDER', './default/path/')#'./V1_Label/'
print('src_folder: ', source_folder)
